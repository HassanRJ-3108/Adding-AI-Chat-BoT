...
const CV = () => {
  return (
    <div className="w-full h-screen flex items-center justify-center bg-gray-100">
      <div className="w-full h-full p-4 bg-white shadow-lg rounded-lg grid grid-cols-1 md:grid-cols-4 gap-4">
        {/* Sidebar for Contact Information */}
        <div className="md:col-span-1 flex flex-col justify-center items-center bg-blue-500 text-black p-4 rounded-lg md:rounded-none md:rounded-l-lg">
