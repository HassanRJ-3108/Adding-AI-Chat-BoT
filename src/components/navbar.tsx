      ...
      <header className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white shadow-lg sticky top-0 z-50">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <Link href="/" className="flex title-font font-medium items-center text-white mb-4 md:mb-0">
            <Image src={require("")} alt="portfolio" width={50} height={50} className="w-12 rounded-full shadow-lg" />
          ...
          <a href="c:\Next-js-App\CV 04-01-2024" download className="mt-4 md:mt-0">
