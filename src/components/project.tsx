...
const Project = () => {
  return (
    <div id="project" className="bg-gray-900 text-gray-400 min-h-screen flex flex-col justify-center py-16">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            <div key={index} className="p-4">
              <div className={`p-6 border-4 border-gray-800 ${project.bgColor} rounded-lg h-full flex flex-col justify-between`}>
                <div>
                ...
                <Link href={project.url} legacyBehavior>
                  <a className="text-yellow-400 hover:text-yellow-300 underline self-start" target="_blank">
                    View Project
                  </a>
                </Link>
              </div>
